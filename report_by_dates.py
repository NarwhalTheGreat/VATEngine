...
def report_by_dates(username, password, date_from, date_to, hostname):
    ...
    WHERE o."CreatedOn" >= :date_from
      AND o."CreatedOn" <  :date_to
    ...
    # Run query 1
    df1 = pd.read_sql(query1.bindparams(date_from=date_from, date_to=date_to), connection_ordering)
